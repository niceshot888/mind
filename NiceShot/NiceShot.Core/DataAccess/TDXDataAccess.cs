        ...
        public static void UpdateForeRoeAndNP(string ts_code,List<string> dataArr)
        {
            try
            {
                ...
                using (IDbConnection conn = new MySqlConnection(MySqlDbHelper.NICESHOTDB_CONN_STRING))
                {
                    ...
                    {
                        id = stockInfo.id,
                        fore_roe_1yearlater = dataArr[6],
                        fore_roe_2yearlater = dataArr[7],
                        fore_roe_3yearlater = dataArr[8],
                        fore_np_1yearlater = dataArr[12],
                        fore_np_2yearlater = dataArr[13],
                        fore_np_3yearlater = dataArr[14],
                    });
