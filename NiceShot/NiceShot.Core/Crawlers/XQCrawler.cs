...
namespace NiceShot.Core.Crawlers
{
    public class XQCrawler
    {
        ...
        private string xq_fin_indicator_url = "https://stock.xueqiu.com/v5/stock/finance/cn/indicator.json?symbol={0}&type=all&is_detail=true&count=1000";
        ...
        private DateTime latest_sync_date = new DateTime(1980, 10, 30);
